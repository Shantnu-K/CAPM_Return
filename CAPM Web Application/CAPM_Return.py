...
# Get user input for stock selection and number of years
...
try:
    ...
    # Download stock price data for selected stocks
    ...
    # Display stock prices before and after normalization
    col1, col2 = st.columns([1, 1])
    with col1:
    ...
    # Calculate and display beta values
    ...
    # Calculate and display returns using CAPM
    rf = 0
